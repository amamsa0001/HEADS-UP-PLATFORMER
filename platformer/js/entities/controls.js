    ...
    pointerMove(event) {
        if (this.released === false) {
            ...
            if (this.getBounds().contains(x, y)) {
                ...
                if (this.cursors.left === true || this.cursors.right === true || this.cursors.a === true || this.cursors.d === true) {
